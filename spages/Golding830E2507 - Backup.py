...
def app():
    ...
    latestReadFile = "pwsReadingsLatest.xlsx"  # 存储最新传感器数据的Excel文件路径

    Tray1_databasedPath = 'Boddington_pwsTray_Database_update.xlsx'     
    Tray1_sensorResults = process_sensor_data(Tray1_databasedPath)

    #Tray2_databasedPath = 'Boddington_btsTray_Database_update.xlsx'      
    #Tray2_sensorResults = process_sensor_data(Tray2_databasedPath, latestReadFile)
    ...
    Tray1_sensor, Tray2_sensor = st.tabs(["LinerLess Tray w/ Passive Wear Sensor", "Future Trials"])
    with Tray1_sensor:
